...
import tattoo_8_img from "../assets/tattoo_8.jpg";
import tattoo_9_img from "../assets/tattoo_9.jpg";
import tattoo_10_img from "../assets/tattoo_10.jpg";
import tattoo_11_img from "../assets/tattoo_11.jpg";
import tattoo_12_img from "../assets/tattoo_12.jpg";
import tattoo_13_img from "../assets/tattoo_13.jpg";
import tattoo_14_img from "../assets/tattoo_14.jpg";
import tattoo_15_img from "../assets/tattoo_15.jpg";
...
const ProjectsBoard = () => {
    ...
    return (
        <div id={"projects-board"} className={"pb-6 2xl:pb-0 2xl:overflow-visible w-screen xl:w-[85vw] 2xl:w-[55vw] " +
            "scroll-mt-12 md:scroll-mt-8 lg:scroll-mt-24 xl:scroll-mt-1 2xl:scroll-mt-6 flex flex-col gap-6 md:gap-8 lg:gap-20 xl:gap-6 2xl:gap-8 " +
            "items-center pl-6 pr-6 pt-20"}>
            <h2 className={"appear text-po text-center text-7xl md:text-[126px] lg:text-[148px] xl:text-[140px] 2xl:text-[148px] font-BlackKnight"}>{t('projects.title')}</h2>
            <div className={"flex flex-col gap-24 lg:gap-36 xl:gap-20 2xl:gap-24 justify-start items-start pt-12 box-border w-full"}>
                <div className={"flex gap-24 lg:gap-36 xl:gap-0 flex-col xl:flex-row items-center xl:items-start xl:justify-around 2xl:justify-between w-full"}>
